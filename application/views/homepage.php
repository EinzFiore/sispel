              ...
              <div class="col-12 col-md-4 col-lg-4">
                <article class="article article-style-c">
                  <div class="article-header">
                    <img class="article-image" src="<?= base_url('assets/img/program/') . $pr['gambar'] ?>">
                    </img>
                  </div>
                  <div class="article-details">
                    <div class="article-category"><a href="#">Pelatihan</a> <div class="bullet"></div> <a href="#">5 Days</a></div>
